...
A proposed MIT-licensed, Docker Compose-first MCP server for safely observing and managing Uptime Kuma.
...
- an explicit Uptime Kuma compatibility matrix and live contract tests;
